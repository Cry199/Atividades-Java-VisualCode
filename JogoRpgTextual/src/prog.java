  ...
  public static void main(String[] args)
  {
    ...
    /* 
      ...
      System.out.println("Digite jogar para jogar!");
        jogar = newScan.next();
      }while(! jogar.equalsIgnoreCase("jogar"));
      limpar(); 
    */
    ...
    System.out.println();
    //-------------------------------------------------------------------
    if(num1==1&&resp1==2&&salaCobra==1||num1==1&&resp1==3&&faca==1||num1==1&resp1==4&&rezar==0||num1==3||num1==2&&resp1==3||num1==2&&opcao==2){
    ...
    System.out.println();
    //-------------------------------------------------------------------
if(num2==1&&lobo==1||num2==1&&lobo==2||num2==1&&lobo==3&&chanceLobo==3||
   num2==2&&resp2==2&&oasis==2||num2==2&&resp2==3){
   num3 = (int) (Math.random()*3)+1;
   resp3 =  terceiraSala(num3);
  limpar();
   if(num3==1&&resp3.equalsIgnoreCase("Relogio")||num3==2&&resp3.equalsIgnoreCase("Mercurio")||num3==3&&resp3.equalsIgnoreCase("Mapa")){
     acertoSala3();
     acertoSala3 =1;
   }
  else{
